...
bash
git clone https://github.com/YOUR_USERNAME/cryptography-portfolio.git
...
3. Follow the console prompts — each script asks for necessary inputs (numbers, modulus, etc.) and prints intermediate steps.
